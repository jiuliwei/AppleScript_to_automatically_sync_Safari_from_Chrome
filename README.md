...
- This script first resets safari bookmarks to empty(the maximum number of bookmarks in the root directory is 20, but you can motidy it), and then imports bookmarks, passwords and history from chrome. 
